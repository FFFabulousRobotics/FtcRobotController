...
public final class TankDrive {
    public static class Params {
        ...
        public double inPerTick = 560;
        public double trackWidthTicks = 14.17323;
        ...
        public double maxWheelVel = 23.653459495922515;
        public double minProfileAccel = -23.653459495922515;
        public double maxProfileAccel = 23.653459495922515;

        // turn profile parameters (in radians)
        public double maxAngVel = Math.toRadians(95.61993984434034); // shared with path
        public double maxAngAccel = Math.toRadians(95.61993984434034);
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            {
                ArrayList<Encoder> leftEncs = new ArrayList<>();
            ...
            {
                ArrayList<Encoder> rightEncs = new ArrayList<>();
        ...
        public PoseVelocity2d update() {
            ...
            ArrayList<Object> leftReadings = new ArrayList<>();
            ArrayList<Object> rightReadings = new ArrayList<>();
