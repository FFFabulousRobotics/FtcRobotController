...
public class AutoTestFULL extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //开局
        robotAuto.grab();
        robotAuto.gotoPos(11,-20);//第一0次到杆前
        ...
        robotAuto.gotoPosWithHeading(-21,-16,90);//到位置1，准备北上
        robotAuto.gotoPosWithHeading(-21,-35,90 );//到位置2
        robotAuto.gotoPos(-27,-35);//到sample1上面
        robotAuto.gotoPosWithHeading(-27,-5,90);//推sample1到人玩区
        // 如果要推更多的sample，在这里写

        robotAuto.spin(180);
        robotAuto.gotoPosWithHeading(-24,-7,180);
        robotAuto.release();//保持后手张开
        robotAuto.gotoPos(-24,-3);//放入标本
        sleep(500);
        robotAuto.grab();//夹住
        ...
        sleep(300);
        robotAuto.gotoPosWithHeading(3,-28,0);//第二次到杆前
...
//        robotAuto.spin(1);
        ...
        robotAuto.gotoPosWithHeading(-24,-7,180);//到标本前并且面对

        robotAuto.release();
        robotAuto.gotoPos(-24,-3,180);//使标本进入
        sleep(500);
        robotAuto.grab();
        ...
        sleep(500);
        robotAuto.gotoPosWithHeading(7,-28,0);//第三次到杆前
        sleep(100);
